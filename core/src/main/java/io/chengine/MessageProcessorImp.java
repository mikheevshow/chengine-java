...
public class MessageProcessorImp {
	...
	public MessageProcessorImp(ChengineHandlerContext chengineHandlerContext, Collection<BotMessagingConnector> botMessagingConnectors) {
